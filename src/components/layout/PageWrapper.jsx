...
const MORE_ITEMS = [
  {
    ...
    items: [
      ...
      { path: '/dashboard', icon: Zap,           label: 'Dashboard', sub: 'Revenue • Sales overview'     },
...
function BottomNav({ onMorePress }) {
  ...
  const moreActive = ['/profile','/shop','/orders','/messages','/settings','/dashboard','/map'].includes(current)
...
export default function PageWrapper({ children }) {
  ...
  return (
    <div style={{ minHeight:'100vh',width:'100%',maxWidth:'100vw',overflowX:'hidden',background:C.bg }}>
